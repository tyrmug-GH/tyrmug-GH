...
1. GATEKEEPING: No release signal is permitted unless Agent B provides "DOCS_VALIDATED" status.
2. OPTIMIZATION: Calculate "Optimal Handover Date" as the earliest date where interest accrual exceeds $X/day and all legal title transfers are confirmed.
...
3. Step 3 - Output Decision: Provide binary status (HOLD vs. RELEASE) with accompanying rationale.
